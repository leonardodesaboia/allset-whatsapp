...
import { z } from "zod";
export interface ProcessInboundEventInput { provider: string; externalId: string; sender: string; recipient: string; payload: InboundMessagePayload; correlationId?: string; actor?: string; }
